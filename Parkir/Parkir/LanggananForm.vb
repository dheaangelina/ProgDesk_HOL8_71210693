...
Public Class LanggananForm
    Private Function IsLangganan(ByVal noPlat As String) As Boolean
        Dim sql As String = "SELECT COUNT(*) FROM tbllangganan WHERE no_plat = '" & noPlat & "'"
    ...
    Private Sub btnLogin_Click(sender As Object, e As EventArgs) Handles btnTambah.Click
